...
class Stack(Generic[T]):
    ...
    @property
    def empty(self) -> bool:
        return not self._container # not is used to convert the list to a boolean

    def push(self, item: T) -> None:
        self._container.append(item)

    def pop(self) -> T:
        return self._container.pop() # pop() removes the last item from the list and returns it
